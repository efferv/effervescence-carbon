...
EFF_AbstractDevice::EFF_AbstractDevice(AudioObjectID inObjectID,
...
EFF_AbstractDevice::~EFF_AbstractDevice()
{
}
...
bool    EFF_AbstractDevice::HasProperty(AudioObjectID inObjectID,
                                        pid_t inClientPID,
...
bool    EFF_AbstractDevice::IsPropertySettable(AudioObjectID inObjectID,
                                               pid_t inClientPID,
                                               const AudioObjectPropertyAddress& inAddress)
const
{
...
UInt32    EFF_AbstractDevice::GetPropertyDataSize(AudioObjectID inObjectID,
                                                  pid_t inClientPID,
                                                  const AudioObjectPropertyAddress& inAddress,
...
void    EFF_AbstractDevice::GetPropertyData(AudioObjectID inObjectID,
                                            pid_t inClientPID,
                                            const AudioObjectPropertyAddress& inAddress,
                                            UInt32 inQualifierDataSize,
                                            const void* __nullable inQualifierData,
...
const
{
    ...
    switch(inAddress.mSelector)
    {
        ...
        case kAudioDevicePropertyAvailableNominalSampleRates:
            ...
            // a required property that can't be handled by this class or its parent, EFF_Object.
            // See EFF_Device for info about these properties.
            // TODO: Write a test that checks all required properties for each subclass.
            EFFAssert(false,
                      "EFF_AbstractDevice::GetPropertyData: Property %u not handled in subclass",
                      inAddress.mSelector);
        ...
        case kAudioDevicePropertyTransportType:
            ...
            ThrowIf(inDataSize < sizeof(UInt32),
                    ...
                    "EFF_AbstractDevice::GetPropertyData: not enough space for the return value of "
